# Tic-Tac-Toe With PostgreSQL, Express, and React

End-to-end React tic-tac-toe game backed by an Express API server, persisting data (game leaderboard) to
PostgreSQL database.

[See the app on Heroku][live].
...
[live]: https://pern-stack-game.herokuapp.com/
